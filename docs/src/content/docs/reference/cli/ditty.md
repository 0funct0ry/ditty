---
title: ditty
description: CLI reference for ditty, generated from the Cobra command tree.
---

## ditty

Share a terminal over the web from a single binary

### Synopsis

ditty shares a terminal over the web from a single Go binary.
...
* [ditty completion](/reference/cli/completion/)	 - Generate a shell completion script
* [ditty config](/reference/cli/config/)	 - Manage ditty configuration
* [ditty run](/reference/cli/run/)	 - Start a Session and share it over the web
* [ditty users](/reference/cli/users/)	 - Manage --auth-db users
* [ditty version](/reference/cli/version/)	 - Print the ditty version
